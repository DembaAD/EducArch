...
class Article(models.Model):
	...
	date = models.DateTimeField(
		auto_now_add=True, auto_now=False, verbose_name="Date de parution")
...
class EtudiantReponse(models.Model):
    etudiant = models.ForeignKey(
    	Etudiant, on_delete=models.CASCADE, related_name='quiz_answers')
    reponse = models.ForeignKey(
    	Reponse, on_delete=models.CASCADE, related_name='+')
